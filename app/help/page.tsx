...
const SECTIONS: { emoji: string; title: string; lines: string[] }[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "옷장: 의상 4벌·액세서리 4종을 사서 입히면 캐릭터 복장이 실제로 바뀌어요(교복 대신 후드티, 캡모자…). 의상 1벌 + 액세서리 1개 동시 착용.",
      ...
      "자동차: 경차→세단→수입차, 업그레이드는 차액만. 집·차·보증금은 순자산으로 남아 엔딩 점수·부자 판정·2세대 유산에 전부 반영돼요(대출은 빚으로 차감).",
    ],
  },
  {
    emoji: "👶",
