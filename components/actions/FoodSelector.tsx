  ...
  return (
    <>
      <button
        ...
        className="toy-btn relative flex w-full items-center gap-3 border border-black/5 bg-blush/40 text-left shadow-soft disabled:opacity-60"
      >
        <span className="text-3xl">🍚</span>
        <span className="flex-1">
          <span className="block text-base font-extrabold">밥 먹이기</span>
        ...
        >
          ...
          >
            <div className="mb-4 flex items-center justify-between">
              <h3 className="text-lg font-extrabold">무엇을 먹일까요?</h3>
              <button
                type="button"
                onClick={() => setOpen(false)}
            ...
            <div className="grid grid-cols-2 gap-2.5">
              {FOODS.map((f) => (
                <button
                  ...
                  className="toy-btn flex flex-col items-start gap-1 border border-black/5 bg-white shadow-soft hover:-translate-y-0.5"
                >
